...
<body>
	...
	<div data-role="page">
		...
		<div data-role="header">
			...
			<h3>
				&nbsp;<%=player.getId()%></h3>
			<a href="#" id="myTotalChips" class="ui-btn ui-icon-shop ui-btn-icon-left">$<%=player.getTotalChips()%></a>
		</div>
		<!-- MIDDLE PANEL  -->
		<div role="main" class="ui-content">
			...
			<div class="ui-grid-d ui-block-solo"
				...
				<div class="ui-block-a" style="width: 20%; height: 100%; position: relative;">
					<div id="connectionStatus" class="circleConnect circleConnected" style="display: none;"></div>
				</div>
