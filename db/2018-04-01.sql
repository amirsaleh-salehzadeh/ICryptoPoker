...
INSERT INTO `finance_payments` (`payment_id`, `creator_username`, `username`, `date_time`, `status`, `amount`, `payment_reason`, `bank_response`, `currency`) VALUES
(0, '', 'amir', '2018-03-28 00:00:00', 0, 1000, 'game', 'pending', 'rand');
...
(0, '', 'amir', 1000, '2018-03-28 00:00:00', 0, 'rand', 0, 'pending');
